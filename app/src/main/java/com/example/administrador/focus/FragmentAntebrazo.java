 ...
 */
public class FragmentAntebrazo extends Fragment {

    RecyclerView recyclerView;
    TextView parte_cuerpo;
    View rootView;

    public FragmentAntebrazo() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        parte_cuerpo.setText(getResources().getString(R.string.antebrazo));

        SQLHelper db=new SQLHelper(getContext());
        db.opendb();
        Cursor cursor = db.consultExercise("ANTEBRAZO");
