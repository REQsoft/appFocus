 ...
 */
public class FragmentTricep extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        parte_cuerpo.setText(getResources().getString(R.string.triceps));

        SQLHelper db=new SQLHelper(getContext());
        db.opendb();
        Cursor cursor = db.consultExercise("TRICEPS");
