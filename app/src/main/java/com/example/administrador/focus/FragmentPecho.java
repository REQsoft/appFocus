 ...
 */
public class FragmentPecho extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        parte_cuerpo.setText(getResources().getString(R.string.pecho));

        SQLHelper db=new SQLHelper(getContext());
        db.opendb();
        Cursor cursor = db.consultExercise("PECHO");
