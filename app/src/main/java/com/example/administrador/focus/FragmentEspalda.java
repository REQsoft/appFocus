 ...
 */
public class FragmentEspalda extends Fragment {

    RecyclerView recyclerView;
    TextView parte_cuerpo;
    View rootView;

    public FragmentEspalda() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        parte_cuerpo.setText(getResources().getString(R.string.espalda));

        SQLHelper db=new SQLHelper(getContext());
        db.opendb();
        Cursor cursor = db.consultExercise("ESPALDA");
