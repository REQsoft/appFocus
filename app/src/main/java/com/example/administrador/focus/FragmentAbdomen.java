 ...
 */
public class FragmentAbdomen extends Fragment {

    RecyclerView recyclerView;
    TextView parte_cuerpo;
    View rootView;

    public FragmentAbdomen() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        parte_cuerpo.setText(getResources().getString(R.string.abdomen));

        SQLHelper db=new SQLHelper(getContext());
        db.opendb();
        Cursor cursor = db.consultExercise("ABDOMEN");
